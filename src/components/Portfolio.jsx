        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-4">
          ...
          >
            ...
            <div className="opacity-0 group-hover:opacity-100 hover:duration-200">
              <span className="text-2xl font-bold text-sky-500 tracking-wider text-center ml-4">
                Barber Shop
              ...
              <div className="pt-8 text-center">
                <a
                  ...
                  rel="noreferrer"
                >
                  <button className="text-center rounded-lg px-4 py-3 m-2 bg-sky-500 text-white font-bold text-lg">
                    Demo
                  </button>
                </a>
          ...
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 hover:duration-200">
              <span className="text-2xl font-bold text-sky-500 tracking-wider text-center ml-8">
                Netflix Clone
                <p className=" text-xs flex text-center">
          ...
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 hover:duration-200">
              <span className="text-2xl font-bold text-sky-500 tracking-wider text-center ml-12">
                Perfil Github API
          ...
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 hover:duration-200">
              <span className="text-2xl font-bold text-sky-500 tracking-wider text-center ml-6">
                Clients Api
                <p className=" text-xs flex text-center">
          ...
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 hover:duration-200">
              <span className="text-2xl font-bold text-sky-500 tracking-wider text-center ml-10">
                Letme Ask
                <p className=" text-xs flex text-center">
          ...
          >
            {/* Hover Effects */}
            <div className="opacity-0 group-hover:opacity-100 hover:duration-200">
              <span className="text-2xl font-bold text-sky-500 tracking-wider text-center ml-20">
                Ignite Lab
                <p className=" text-xs flex text-center m-1">
